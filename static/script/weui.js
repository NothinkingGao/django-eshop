...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gaoMing = __webpack_require__(17);

	var _gaoMing2 = _interopRequireDefault(_gaoMing);
	...
	var _productSelect = __webpack_require__(35);
	...
	exports.default = {
	    ...
	    productSelect: _productSelect2.default
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gaoMing = __webpack_require__(18);
	...
	function gaoMing(content) {
	    ...
	    var $gaoMing = (0, _util2.default)(_util2.default.render(_gaoMing2.default, options));
	    function _hide(callback) {
	        _hide = _util2.default.noop; // 防止二次调用导致报错
	    ...
	    (0, _util2.default)('body').append($gaoMing);
	    if (_gaoming) {
	        clearTimeout(_gaoming.timeout);
	        _gaoming.hide();
	    }
	    ...
	    _gaoming.timeout = setTimeout(hide, options.duration);

	    $gaoMing[0].hide = hide;
	    return $gaoMing[0];
	}
	exports.default = gaoMing;
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _productSelect2 = __webpack_require__(36);

	var _productSelect3 = _interopRequireDefault(_productSelect2);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var _productSelect = null;

	function productSelect(number) {
	    var selects = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	    ...
	    var $productSelectWrap = (0, _util2.default)(_util2.default.render(_productSelect3.default, options));
	    var $productSelectMask = $productSelectWrap.find('.weui-mask');
	    var $productSelect = $productSelectWrap.find('.weui-product-select');
	    ...
	    function _hide(callback) {
	        ...
	        $productSelectMask.addClass('weui-animate-fade-out').on('animationend webkitAnimationEnd', function () {
	    ...
	    (0, _util2.default)('body').append($productSelectWrap);

	    $productSelectMask.addClass('weui-animate-fade-in').on('click', function () {
	        hide();
	    });
	    ...
	    $productSelectWrap.find('.weui-product-select__item').on('click', '.select-option', function () {
	        ...
	        (0, _util2.default)(this).addClass('standard-select-red');
	    });
	    //数量增加和减少
	    var $productCount = $productSelectWrap.find('.weui-product-select__count');
	    $productSelectWrap.on('click', '.weui-product-select__add', function () {
	        var select = selects[options.index];
	        var $productCountVal = parseInt($productCount.val());
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"<%= className %>\"> <div class=weui-mask></div> <div class=weui-product-select> <div class=weui-product-select__title> <div class=weui-product-select__thumb> <img class=weui-product-select__src src=\"<%=selects[index].thumb%>\" alt=\"\" style=width:100px;height:100px /> </div> <div style=\"margin:20px 0 0 128px\"> <p class=weui-product-select__price>￥<%=selects[index].price%></p> <p> 商品编号:<%=number%> </p> </div> </div> <div class=weui-product-select__body> <p class=weui-product-select__item_hd> 已选 <span style=float:right> <span>库存:</span><span class=weui-product-select__stock><%=selects[index].stock%></span> </span> </p> <p class=weui-product-select__item> <% for(var i = 0; i < selects.length; i++){ %> <% if(index==i){ %> <span class=\"select-option standard-select-red\"><%=selects[i].option%></span> <% }else{ %> <span class=select-option><%=selects[i].option%></span> <%}%> <% } %> </p> <div class=weui-product-select__item> <span>数量</span> <div class=weui-price__count style=display:inline-block;float:right;padding-right:10px> <span class=weui-product-select__plus>-</span> <input type=text class=weui-product-select__count value=2 /> <span class=weui-product-select__add>+</span> </div> </div> <p> <a href=javascript:; class=\"weui-addin weui-btn weui-btn_warn\" style=border-radius:0>加入购物车</a> </p> </div> </div> </div>";
